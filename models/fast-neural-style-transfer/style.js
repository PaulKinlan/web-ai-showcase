// Front-end helpers shared by every Fast Neural Style Transfer page. Keeps pages thin: owns the worker
...
//
// No synthetic degradation — a straight photo→painting conversion. Five artistic styles load lazily.

const WORKER_URL = "/web-ai-showcase/models/fast-neural-style-transfer/worker.js";
...
export const STYLE_LABELS = {
  ...
  "rain-princess": "Rain Princess (Afremov)",
};
...
export class RevealCompare {
  ...
  _apply() {
    ...
    this.range.setAttribute("aria-valuetext", `${Math.round(pct)}% painted`);
  }
...
/** Shared inline styles for the style-transfer widgets. Structural only — colours from design-system vars. */
