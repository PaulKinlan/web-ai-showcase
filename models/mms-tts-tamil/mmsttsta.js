// Front-end helpers for the MMS-TTS Tamil (VITS) pages. Thin: owns the worker handshake, WAV encoding
// and the waveform canvas. All inference runs in worker.js, off the main thread.
//
// Model: naklitechie/mms-tts-ta-ONNX — a faithful ONNX export of the canonical Meta MMS TAMIL VITS
// checkpoint (its vocab.json is byte-identical to facebook/mms-tts-tam). ~109 MB fp32, 16 kHz mono
// output. This is a DISTINCT model from the built English/German/Spanish/French/Arabic/Vietnamese/Hindi
// MMS-TTS demos: its own native Tamil-script char vocab (58 symbols, is_uroman:false — a different script
// from Hindi's Devanagari) + Tamil-trained VITS weights. The worker reproduces the VitsTokenizer exactly
// (verified identical to the real tokenizer) because this export omits tokenizer.json.

const WORKER_URL = "/web-ai-showcase/models/mms-tts-tamil/worker.js";
export const MODEL_ID = "naklitechie/mms-tts-ta-ONNX";

export class MmsTaEngine {
  constructor() {
  ...
  /** Synthesize Tamil text → { audio: Float32Array, rate, ms, samples, device, inputIds } */
...
// A small set of Tamil (Tamil script) example lines that exercise vowel signs, pulli and phrasing.
export const TAMIL_SAMPLES = [
  {
    label: "அறிமுகம்",
    text: "இந்தக் குரல் முழுவதுமாக உங்கள் உலாவியில் உருவாக்கப்படுகிறது, எந்த சேவையகமும் இல்லாமல்.",
  },
  {
    label: "வணக்கம்",
    text: "வணக்கம்! நீங்கள் எப்படி இருக்கிறீர்கள்? உங்களைச் சந்தித்ததில் மகிழ்ச்சி.",
  },
  {
    label: "வானிலை",
    text: "இந்த வார இறுதியில் வானிலை பெரும்பாலும் தெளிவாக இருக்கும், அதிகபட்ச வெப்பநிலை முப்பத்திரண்டு டிகிரி.",
  },
  {
    label: "செய்தி",
    text: "மொழி மாதிரியை முழுவதுமாக உலாவியில் இயக்கும் புதிய முறையை ஆராய்ச்சியாளர்கள் அறிமுகப்படுத்தியுள்ளனர்.",
  },
  {
    label: "அறிவிப்பு",
    text: "தயவுசெய்து கவனிக்கவும்: சென்னைக்குச் செல்லும் ரயில் இன்று ஐந்தாம் நடைமேடையிலிருந்து புறப்படும்.",
  },
  {
    label: "பழமொழி",
    text: "அறிவை வளர்த்தால் அறிவே காக்கும்; கற்றது கை மண் அளவு, கல்லாதது உலகளவு.",
  },
];
