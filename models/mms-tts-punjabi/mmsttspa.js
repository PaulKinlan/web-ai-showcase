// Front-end helpers for the MMS-TTS Punjabi (VITS) pages. Thin: owns the worker handshake, WAV encoding and
// the waveform canvas. All inference runs in worker.js, off the main thread.
//
// Model: naklitechie/mms-tts-pa-ONNX — a faithful ONNX export of the canonical Meta MMS PUNJABI VITS
// checkpoint (its vocab.json is byte-identical to facebook/mms-tts-pan). ~109 MB fp32, 16 kHz mono output.
// This is a DISTINCT model from the built English/German/Spanish/French/Arabic/Vietnamese/Hindi/Tamil/
// Gujarati/Telugu/Marathi MMS-TTS demos: its own native Gurmukhi char vocab (59 symbols, is_uroman:false —
// a script distinct from Devanagari, Tamil and Gujarati) + Punjabi-trained VITS weights. The worker
// reproduces the VitsTokenizer exactly (verified identical to the real tokenizer on Xenova/mms-tts-hin)
// because this export omits tokenizer.json.

const WORKER_URL = "/web-ai-showcase/models/mms-tts-punjabi/worker.js";
export const MODEL_ID = "naklitechie/mms-tts-pa-ONNX";

export class MmsPaEngine {
  constructor() {
  ...
  /** Synthesize Punjabi text → { audio: Float32Array, rate, ms, samples, device, inputIds } */
...
// A small set of Punjabi (Gurmukhi) example lines that exercise vowel signs, addak and phrasing.
export const PUNJABI_SAMPLES = [
  {
    label: "ਜਾਣ-ਪਛਾਣ",
    text: "ਸਤ ਸ੍ਰੀ ਅਕਾਲ, ਇਹ ਆਵਾਜ਼ ਪੂਰੀ ਤਰ੍ਹਾਂ ਤੁਹਾਡੇ ਬ੍ਰਾਊਜ਼ਰ ਵਿੱਚ ਬਣਦੀ ਹੈ, ਕਿਸੇ ਸਰਵਰ ਤੋਂ ਬਿਨਾਂ।",
  },
  {
    label: "ਸਤ ਸ੍ਰੀ ਅਕਾਲ",
    text: "ਸਤ ਸ੍ਰੀ ਅਕਾਲ! ਤੁਸੀਂ ਕਿਵੇਂ ਹੋ? ਤੁਹਾਨੂੰ ਮਿਲ ਕੇ ਖੁਸ਼ੀ ਹੋਈ।",
  },
  {
    label: "ਮੌਸਮ",
    text: "ਇਸ ਹਫ਼ਤੇ ਦੇ ਅੰਤ ਵਿੱਚ ਮੌਸਮ ਜ਼ਿਆਦਾਤਰ ਸਾਫ਼ ਰਹੇਗਾ, ਵੱਧ ਤੋਂ ਵੱਧ ਤਾਪਮਾਨ ਬੱਤੀ ਡਿਗਰੀ।",
  },
  {
    label: "ਖ਼ਬਰ",
    text: "ਖੋਜਕਾਰਾਂ ਨੇ ਭਾਸ਼ਾ ਮਾਡਲ ਪੂਰੀ ਤਰ੍ਹਾਂ ਬ੍ਰਾਊਜ਼ਰ ਵਿੱਚ ਚਲਾਉਣ ਦਾ ਨਵਾਂ ਤਰੀਕਾ ਪੇਸ਼ ਕੀਤਾ ਹੈ।",
  },
  {
    label: "ਐਲਾਨ",
    text: "ਕਿਰਪਾ ਕਰਕੇ ਧਿਆਨ ਦਿਓ: ਅੰਮ੍ਰਿਤਸਰ ਜਾਣ ਵਾਲੀ ਗੱਡੀ ਅੱਜ ਪੰਜਵੇਂ ਪਲੇਟਫਾਰਮ ਤੋਂ ਰਵਾਨਾ ਹੋਵੇਗੀ।",
  },
  {
    label: "ਅਖਾਣ",
    text: "ਬੂੰਦ ਬੂੰਦ ਨਾਲ ਤਲਾਬ ਭਰਦਾ ਹੈ; ਕੀਤਿਆਂ ਹੀ ਕੰਮ ਹੁੰਦਾ ਹੈ, ਪਹਿਲਾਂ ਕਰਨਾ ਪੈਂਦਾ ਹੈ।",
  },
];
