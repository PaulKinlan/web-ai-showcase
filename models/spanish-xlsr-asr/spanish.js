// Front-end helpers for the wav2vec2-XLSR-53 (Spanish) pages. Keeps each page thin: worker handshake,
...
//
// DISTINCT from the English wav2vec2, Russian XLSR AND French XLSR demos: this model is XLSR-53
// fine-tuned for SPANISH — a Latin-script recogniser over a 41-symbol vocab with the Spanish diacritics
// (á é í ó ú ü) and ñ — so it is language-specialised for Spanish. The engine is otherwise the same CTC
// shape (per-frame argmax → collapse), which lets the page visualise the collapse over the Spanish
// alphabet.

const WORKER_URL = "/web-ai-showcase/models/spanish-xlsr-asr/worker.js";
const TARGET_RATE = 16000;

export class SpanishXlsrEngine {
  constructor() {
...
/** Render per-word forced-alignment chips (Spanish word + start–end seconds). */
