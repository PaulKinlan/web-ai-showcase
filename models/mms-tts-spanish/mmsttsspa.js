// Front-end helpers for the MMS-TTS Spanish (VITS) pages. Thin: owns the worker handshake, WAV encoding
// and the waveform canvas. All inference runs in worker.js, off the main thread.
//
// Model: Xenova/mms-tts-spa — the SPANISH VITS checkpoint from Meta's MMS family (ONNX q8, ~38 MB, 16 kHz
// mono output). This is a DISTINCT model from the built English and German MMS-TTS demos: Spanish
// character vocab + Spanish-trained VITS weights, so it speaks Spanish orthography (ñ, á/é/í/ó/ú, ü)
// natively.

const WORKER_URL = "/web-ai-showcase/models/mms-tts-spanish/worker.js";
export const MODEL_ID = "Xenova/mms-tts-spa";

export class MmsEsEngine {
  constructor() {
  ...
  /** Synthesize Spanish text → { audio: Float32Array, rate, ms, samples, device } */
...
// A small set of Spanish example lines that exercise ñ, accented vowels and Spanish phrasing/punctuation.
export const SPANISH_SAMPLES = [
  {
    label: "Presentación",
    text: "Esta voz se genera completamente en tu navegador, sin ningún servidor.",
  },
  {
    label: "Trabalenguas",
  ...
  {
    label: "La eñe y los acentos",
    text: "El pequeño niño español añora las cálidas mañanas de la montaña.",
  },
  {
    label: "Anuncio",
    text: "Su cita está confirmada para el martes a las nueve y media. Por favor, sea puntual.",
  },
  {
    label: "El tiempo",
    text:
      "El fin de semana estará mayormente despejado, con máximas alrededor de veintidós grados.",
  },
  {
    label: "¿Preguntas? ¡Saludos!",
    text: "¿Cómo estás? ¡Qué gusto verte! Espero que tengas un día maravilloso.",
  },
];
