// Florence-2 worker — task-prompted vision inference off the main thread, with honest WebGPU gating.
// Model: onnx-community/Florence-2-base-ft (image-text-to-text), WebGPU, dtype fp16.
// Canonical Transformers.js Florence-2 path (verified against v3.7.5):
...
self.addEventListener("message", async (e) => {
  ...
  try {
    ...
    console.error("[florence worker] error", err);
