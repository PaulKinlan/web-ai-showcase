// Depth Anything v2 (small) worker — runs ALL depth inference off the main thread so the control UI
...
//
// Model: onnx-community/depth-anything-v2-small (task: depth-estimation), WebGPU fp16 with WASM
// fallback. Uses the SHARED loader from lib/webai.js and the real transformers.js pipeline output —
// { depth: RawImage (normalized 0–255 grayscale), predicted_depth: Tensor (raw metric-ish values) }.
...
import { sampleMap } from "/web-ai-showcase/models/depth-anything/depth.js";
