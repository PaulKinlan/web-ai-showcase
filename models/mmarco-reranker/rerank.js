// Front-end helpers for the mMARCO mMiniLMv2 multilingual cross-encoder pages. Owns the worker handshake
// and the renderers (ranked passage list, before/after reordering, cross-encoder-vs-lexical contrast).
// All inference lives in worker.js (off the main thread).

const WORKER_URL = "/web-ai-showcase/models/mmarco-reranker/worker.js";
...
.rr-text { margin: .3rem 0; font-size: .92rem; white-space: pre-wrap; word-break: break-word; }
