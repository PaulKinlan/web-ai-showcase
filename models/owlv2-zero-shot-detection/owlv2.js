// Shared front-end helpers for the OWLv2 zero-shot detection pages. Keeps each page thin: it owns the
// worker handshake, turns files/samples into data URLs, draws the box overlay (coloured per text
// query), parses the query field, and summarises per-query scores. All inference is in worker.js.

const WORKER_URL = "/web-ai-showcase/models/owlv2-zero-shot-detection/worker.js";
