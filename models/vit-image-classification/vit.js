// Shared front-end helpers for the ViT image-classification pages. Keeps each page thin: it owns the
...
const WORKER_URL = "/web-ai-showcase/models/vit-image-classification/worker.js";

export class ViTEngine {
  constructor() {
  ...
  /** Classify an image. Returns { labels, probs, logits, topK, entropy, margin, numClasses, ms, device }. */
...
/** Shared inline styles for the ViT widgets (bars, dropzone, readout). Injected once per page. */
export const VIT_CSS = `
.dropzone {
