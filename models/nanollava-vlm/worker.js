...
async function ensureLoaded() {
  ...
  console.log(`[nanollava worker] loading ${MODEL_ID} on webgpu (decoder q4f16)`);
...
async function run(id, imageURL, prompt, system, maxTokens) {
  ...
  // LLaVA-style ChatML: a system line + a user turn whose content embeds the <image> placeholder.
  const messages = [
