...
// Indigo overlay by default — matches the design accent and passes over most photos.
...
/**
 * Draw `imgEl` at natural resolution onto `canvas`, then overlay the mask as a translucent colour with
 * a crisp outline, plus a marker at each prompt point. Canvas is scaled down by CSS responsively.
 */
export function drawMaskOverlay(canvas, imgEl, mask, w, h, points = [], opts = {}) {
