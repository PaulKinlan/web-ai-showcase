// Front-end engine for the Qwen3 multi-model (RAG) page. MiniLM retrieval + Qwen3 generation run off
// the main thread in mm-worker.js.
const WORKER_URL = "/web-ai-showcase/models/qwen3-0-6b-wasm/mm-worker.js";
export class RagEngine {
  ...
  run(query, notes, { onRetrieved, onToken } = {}) {
    const id = ++this._id;
    return new Promise((res, rej) => {
      this._active = { id, onRetrieved, onToken, resolve: res, reject: rej };
