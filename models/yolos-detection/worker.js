// YOLOS object-detection worker — runs ALL inference off the main thread so the control UI stays
...
//
// Model: Xenova/yolos-tiny (task: object-detection), WASM backend, q8. YOLOS ("You Only Look at One
// Sequence") is a plain ViT-Tiny that treats detection as sequence prediction — no CNN backbone, no
// hand-tuned anchors. Boxes come back in ORIGINAL image pixel coordinates (percentage:false); the
// page scales them to the canvas. We use the SHARED loader from lib/webai.js — no invented API.
