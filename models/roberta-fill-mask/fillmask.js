// Front-end helpers for the RoBERTa fill-mask pages. Thin: owns the worker handshake + renderers.
// All inference (masked-LM logits, softmax, candidate scoring) lives in worker.js, off the main thread.

const WORKER_URL = "/web-ai-showcase/models/roberta-fill-mask/worker.js";
export const MASK = "<mask>";

export class RobertaFillMaskEngine {
  constructor() {
