// Front-end helpers for the MMS-TTS Bengali (VITS) pages. Thin: owns the worker handshake, WAV encoding
...
export class MmsBnEngine {
  ...
  /** Synthesize Bengali text → { audio: Float32Array, rate, ms, samples, device, inputIds } */
...
// A small set of Bengali (Bengali script) example lines that exercise vowel signs, joint letters and phrasing.
export const BENGALI_SAMPLES = [
  {
    label: "পরিচয়",
    text: "এই কণ্ঠস্বর সম্পূর্ণরূপে আপনার ব্রাউজারে তৈরি হয়, কোনো সার্ভার ছাড়াই।",
  },
  {
    label: "শুভেচ্ছা",
    text: "নমস্কার! কেমন আছেন? আপনার সাথে দেখা হয়ে খুব ভালো লাগল।",
  },
  {
    label: "আবহাওয়া",
    text: "আগামীকাল রাজধানীতে আকাশ পরিষ্কার থাকবে, তাপমাত্রা ত্রিশ ডিগ্রির কাছাকাছি।",
  },
  {
    label: "সংবাদ",
    text: "গবেষকরা একটি নতুন পদ্ধতি উপস্থাপন করেছেন, যা দিয়ে ভাষা মডেল সম্পূর্ণরূপে ব্রাউজারে চালানো যায়।",
  },
  {
    label: "ঘোষণা",
    text: "দয়া করে লক্ষ্য করুন: কলকাতাগামী ট্রেনটি আজ প্ল্যাটফর্ম পাঁচ থেকে ছাড়বে।",
  },
  {
    label: "ছড়া",
    text: "কচু বনে কচু খায়, কচু খেতে ভালোবাসে; কচুর পাতে কচু পড়ে, কচু খায় হাসে।",
  },
];
