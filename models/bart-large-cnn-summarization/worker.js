// BART-large-CNN summarization worker — inference off the main thread so the control UI stays smooth.
// Model: Xenova/bart-large-cnn (task: summarization), WASM, q8. The canonical news abstractive
// summarizer (facebook/bart-large-cnn) — higher quality than DistilBART, larger download (~460 MB).
//
// Operations:
