// Russian→English translation worker for the XLSR multi-model demo. Runs OPUS-MT (MarianMT) off the
// main thread so the ASR→translate chain never blocks the UI.
// Model: Xenova/opus-mt-ru-en (task: translation). Same MarianMT class as the built marianmt-translation
// demo, different language pair.
...
async function ensureLoaded() {
  ...
  translator = await pipeline("translation", MODEL_ID, {
    device: DEVICE,
    dtype: "q8", // onnx/*_quantized — verified to translate ru→en correctly on WASM
