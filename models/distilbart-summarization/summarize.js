// Front-end helpers for the DistilBART summarization pages. Keeps each page thin: it owns the worker
// handshake, streaming, and the render helpers. All inference lives in worker.js (off the main thread).

const WORKER_URL = "/web-ai-showcase/models/distilbart-summarization/worker.js";
