// Front-end helpers for the Qwen2.5-0.5B WASM pages: the worker handshake, streaming plumbing, and
// the shared widget CSS. Inference lives in worker.js (WebAssembly / CPU, dtype q8). Every page on
// this model imports this so the chat loop and "see inside" surface stay identical.

const WORKER_URL = "/web-ai-showcase/models/qwen2.5-0.5b-wasm/worker.js";

export class QwenWasmEngine {
  constructor() {
