// StableLM 2 Zephyr 1.6B (WebLLM) worker — chat generation off the main thread via MLC's WebGPU
...
// Model: stablelm-2-zephyr-1_6b-q4f16_1-MLC (Stability AI StableLM 2 Zephyr, 1.6B params, chat-tuned).
// Unlike Gemma, StableLM 2 Zephyr's chat template has a real system role, so we pass system messages
// straight through — no folding.

import { createEngine, streamChat } from "/web-ai-showcase/lib/webllm.js";

const MODEL_ID = "stablelm-2-zephyr-1_6b-q4f16_1-MLC";
let engine = null;
