// Front-end helpers for the MMS-TTS Hindi (VITS) pages. Thin: owns the worker handshake, WAV encoding
// and the waveform canvas. All inference runs in worker.js, off the main thread.
//
// Model: Xenova/mms-tts-hin — the HINDI VITS checkpoint from Meta's MMS family (ONNX q8, ~38 MB, 16 kHz
// mono output). This is a DISTINCT model from the built English/German/Spanish/French/Arabic/Vietnamese
// MMS-TTS demos: its own Devanagari character vocab (72 symbols, is_uroman:false — native Devanagari,
// not romanised Latin) + Hindi-trained VITS weights, so it speaks Devanagari orthography natively.

const WORKER_URL = "/web-ai-showcase/models/mms-tts-hindi/worker.js";
export const MODEL_ID = "Xenova/mms-tts-hin";

export class MmsHiEngine {
  constructor() {
  ...
  /** Synthesize Hindi text → { audio: Float32Array, rate, ms, samples, device } */
...
// A small set of Hindi (Devanagari) example lines that exercise matras, anusvara, conjuncts and phrasing.
export const HINDI_SAMPLES = [
  {
    label: "परिचय",
    text: "यह आवाज़ पूरी तरह आपके ब्राउज़र में ही बनाई जाती है, बिना किसी सर्वर के।",
  },
  {
    label: "अभिवादन",
    text: "नमस्ते! आप कैसे हैं? आपसे मिलकर बहुत खुशी हुई।",
  },
  {
    label: "मौसम",
    text: "इस सप्ताहांत मौसम अधिकतर साफ़ रहेगा और तापमान बत्तीस डिग्री के आसपास रहेगा।",
  },
  {
    label: "समाचार",
    text: "शोधकर्ताओं ने भाषा मॉडल को पूरी तरह ब्राउज़र में चलाने की एक नई विधि प्रस्तुत की है।",
  },
  {
    label: "घोषणा",
    text: "कृपया ध्यान दें: मुंबई जाने वाली ट्रेन आज प्लेटफ़ॉर्म पाँच से रवाना होगी।",
  },
  {
    label: "कविता",
    text: "चंदा मामा दूर के, पूए पकाएँ बूर के; आप खाएँ थाली में, मुन्ने को दें प्याली में।",
  },
];
