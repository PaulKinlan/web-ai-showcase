// Front-end helpers for the CamemBERT fill-mask pages. Thin: owns the worker handshake + renderers.
// All inference (masked-LM logits, softmax, candidate scoring) lives in worker.js, off the main thread.

const WORKER_URL = "/web-ai-showcase/models/camembert-fill-mask/worker.js";
export const MASK = "<mask>";

export class CamembertFillMaskEngine {
  constructor() {
