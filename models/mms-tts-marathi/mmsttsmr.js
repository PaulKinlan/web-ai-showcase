// Front-end helpers for the MMS-TTS Marathi (VITS) pages. Thin: owns the worker handshake, WAV encoding
// and the waveform canvas. All inference runs in worker.js, off the main thread.
//
// Model: naklitechie/mms-tts-mr-ONNX — a faithful ONNX export of the canonical Meta MMS MARATHI VITS
// checkpoint (its vocab.json is byte-identical to facebook/mms-tts-mar). ~109 MB fp32, 16 kHz mono output.
// This is a DISTINCT model from the built English/German/Spanish/French/Arabic/Vietnamese/Hindi/Tamil/
// Gujarati/Telugu MMS-TTS demos: its own native Devanagari (Marathi) char vocab (73 symbols,
// is_uroman:false) + Marathi-trained VITS weights. Marathi shares the Devanagari script with Hindi but is a
// SEPARATE Marathi checkpoint with its own vocab and pronunciation (incl. the Marathi-specific ळ/ऱ). The
// worker reproduces the VitsTokenizer exactly (verified identical to the real tokenizer on Xenova/mms-tts-
// hin) because this export omits tokenizer.json.

const WORKER_URL = "/web-ai-showcase/models/mms-tts-marathi/worker.js";
export const MODEL_ID = "naklitechie/mms-tts-mr-ONNX";

export class MmsMrEngine {
  constructor() {
  ...
  /** Synthesize Marathi text → { audio: Float32Array, rate, ms, samples, device, inputIds } */
...
// A small set of Marathi (Devanagari) example lines that exercise vowel signs, jodakshare and phrasing.
export const MARATHI_SAMPLES = [
  {
    label: "ओळख",
    text: "नमस्कार, हा आवाज पूर्णपणे तुमच्या ब्राउझरमध्ये तयार होतो, कोणत्याही सर्व्हरशिवाय.",
  },
  {
    label: "नमस्कार",
    text: "नमस्कार! तुम्ही कसे आहात? तुम्हाला भेटून खूप आनंद झाला.",
  },
  {
    label: "हवामान",
    text: "या आठवड्याच्या शेवटी हवामान बहुतांशी स्वच्छ राहील, कमाल तापमान बत्तीस अंश.",
  },
  {
    label: "बातमी",
    text: "संशोधकांनी भाषा प्रतिमान पूर्णपणे ब्राउझरमध्ये चालवण्याची नवीन पद्धत सादर केली आहे.",
  },
  {
    label: "घोषणा",
    text: "कृपया लक्ष द्या: पुण्याला जाणारी गाडी आज पाचव्या फलाटावरून सुटेल.",
  },
  {
    label: "म्हण",
    text: "थेंबे थेंबे तळे साचे; केल्याने होत आहे रे, आधी केलेची पाहिजे.",
  },
];
