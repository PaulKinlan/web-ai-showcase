// Front-end helpers for the wav2vec2-XLSR-53 (Portuguese) pages. Keeps each page thin: worker handshake,
...
//
// DISTINCT from the English, Russian, French, Spanish and Italian XLSR demos: this model is XLSR-53 fine-tuned for
// PORTUGUESE — a Latin-script recogniser over a 46-symbol vocab with the Portuguese diacritics (à á â ã ç é ê í ó ô õ ú) — so
// it is language-specialised for Portuguese. The engine is otherwise the same CTC shape (per-frame argmax →
// collapse), which lets the page visualise the collapse over the Portuguese alphabet.

const WORKER_URL = "/web-ai-showcase/models/portuguese-xlsr-asr/worker.js";
const TARGET_RATE = 16000;

export class PortugueseXlsrEngine {
  constructor() {
...
/** Render per-word forced-alignment chips (Portuguese word + start–end seconds). */
