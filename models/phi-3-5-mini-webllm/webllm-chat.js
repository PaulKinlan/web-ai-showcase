// Front-end helpers shared by every Phi-3.5-mini (WebLLM) page: the worker handshake + streaming
...
const WORKER_URL = "/web-ai-showcase/models/phi-3-5-mini-webllm/worker.js";
...
export function webgpuFallbackHTML(probe) {
  ...
  return `
    <strong>Phi-3.5-mini runs on WebLLM, which needs WebGPU — and it isn't available in this browser.</strong>
