// Front-end helpers for the XLM-RoBERTa multilingual NER pages. Thin: owns the worker handshake +
// renderers. All NER inference (token-classification, BIO merge, char-offset mapping) lives in worker.js.

const WORKER_URL = "/web-ai-showcase/models/xlmr-multilingual-ner/worker.js";
...
// Ten fine-tuning (HRL) languages, each with a self-contained sample sentence.
export const SAMPLES = [
  ...
  },
  {
    ...
    code: "de",
    dir: "ltr",
    text: "Wolfgang Schäuble besuchte die Deutsche Bank in Frankfurt am Montag.",
  },
  {
    lang: "Spanish",
    code: "es",
...
// Languages OUTSIDE the ten fine-tuning languages — XLM-R's cross-lingual transfer still tags them.
export const TRANSFER_SAMPLES = [
  {
    lang: "Turkish",
    code: "tr",
    dir: "ltr",
    text: "Kemal Kılıçdaroğlu İstanbul'da Türkiye Cumhuriyeti hakkında konuştu.",
  },
  {
    lang: "Swedish",
    code: "sv",
    dir: "ltr",
    text: "Stefan Löfven träffade Angela Merkel i Stockholm förra veckan.",
  },
  {
    lang: "Japanese",
    code: "ja",
    dir: "ltr",
    text: "田中さんは東京でソニーの新しい本社を訪れました。",
  },
  {
    lang: "Indonesian",
    code: "id",
    dir: "ltr",
    text: "Joko Widodo bertemu dengan perwakilan Google di Jakarta.",
  },
  {
    lang: "Polish",
    code: "pl",
    dir: "ltr",
    text: "Robert Lewandowski gra w FC Barcelonie w Hiszpanii.",
  },
];
...
/** Render the raw per-token BIO tags — the "see inside" surface. Exposes SentencePiece subword splitting. */
...
.ner-chip.transfer { border-style: dashed; }
...
.subgrid { display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: .8rem; margin-top: .6rem; }
.subcard { border: 1px solid var(--border); border-radius: 10px; background: var(--bg-raised); padding: .7rem .9rem; }
.subcard h4 { margin: 0 0 .3rem; font-size: .95rem; }
`;
