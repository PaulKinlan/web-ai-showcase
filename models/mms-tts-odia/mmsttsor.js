// Front-end helpers for the MMS-TTS Odia (VITS) pages. Thin: owns the worker handshake, WAV encoding
// and the waveform canvas. All inference runs in worker.js, off the main thread.
//
// Model: naklitechie/mms-tts-or-ONNX — a faithful ONNX export of the canonical Meta MMS ODIA VITS
// checkpoint (its vocab.json is byte-identical to facebook/mms-tts-ory). ~114 MB fp32, 16 kHz mono
// output. This is a DISTINCT model from the built English/German/Spanish/French/Arabic/Vietnamese/Hindi/
// Tamil/Gujarati/Telugu/Marathi/Punjabi/Malayalam/Urdu MMS-TTS demos: its own native Odia-script char
// vocab (76 symbols, is_uroman:false — the rounded Odia script, distinct from Devanagari, Tamil,
// Malayalam and Gurmukhi) + Odia-trained VITS weights. The worker reproduces the VitsTokenizer exactly
// (verified identical to the real tokenizer) because this export omits tokenizer.json.

const WORKER_URL = "/web-ai-showcase/models/mms-tts-odia/worker.js";
export const MODEL_ID = "naklitechie/mms-tts-or-ONNX";

export class MmsOrEngine {
  constructor() {
  ...
  /** Synthesize Odia text → { audio: Float32Array, rate, ms, samples, device, inputIds } */
...
// A small set of Odia (Odia script) example lines that exercise vowel signs, conjuncts and the
// characteristic rounded letters.
export const ODIA_SAMPLES = [
  {
    label: "ପରିଚୟ",
    text: "ଏହି ସ୍ୱର ସମ୍ପୂର୍ଣ୍ଣ ଭାବରେ ଆପଣଙ୍କ ବ୍ରାଉଜରରେ, କୌଣସି ସର୍ଭର ବିନା ତିଆରି ହୁଏ।",
  },
  {
    label: "ନମସ୍କାର",
    text: "ନମସ୍କାର! ଆପଣ କେମିତି ଅଛନ୍ତି? ଆପଣଙ୍କୁ ଭେଟି ଖୁସି ଲାଗିଲା।",
  },
  {
    label: "ପାଣିପାଗ",
    text: "ଏହି ସପ୍ତାହ ଶେଷରେ ପାଣିପାଗ ଅଧିକାଂଶ ସମୟ ପରିଷ୍କାର ରହିବ, ସର୍ବାଧିକ ତାପମାତ୍ରା ବତିଶ ଡିଗ୍ରୀ।",
  },
  {
    label: "ଖବର",
    text: "ଗବେଷକମାନେ ଭାଷା ମଡେଲକୁ ସମ୍ପୂର୍ଣ୍ଣ ଭାବରେ ବ୍ରାଉଜରରେ ଚଲାଇବାର ଏକ ନୂଆ ଉପାୟ ଉପସ୍ଥାପନ କରିଛନ୍ତି।",
  },
  {
    label: "ଘୋଷଣା",
    text: "ଦୟାକରି ଧ୍ୟାନ ଦିଅନ୍ତୁ: ଭୁବନେଶ୍ୱର ଯିବା ଟ୍ରେନ୍ ଆଜି ପାଞ୍ଚ ନମ୍ବର ପ୍ଲାଟଫର୍ମରୁ ଛାଡ଼ିବ।",
  },
  {
    label: "ପ୍ରବଚନ",
    text: "ଜ୍ଞାନ ବାଣ୍ଟିଲେ ବଢ଼େ; ଶିଖିବାର ଯାତ୍ରା କେବେ ଶେଷ ହୁଏ ନାହିଁ।",
  },
];
