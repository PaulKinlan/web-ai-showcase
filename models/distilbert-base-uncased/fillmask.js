// Front-end helpers for the DistilBERT fill-mask pages. Thin: owns the worker handshake + renderers.
// All inference (masked-LM logits, softmax, candidate scoring) lives in worker.js, off the main thread.

const WORKER_URL = "/web-ai-showcase/models/distilbert-base-uncased/worker.js";
export const MASK = "[MASK]";

export class DistilBertFillMaskEngine {
  constructor() {
...
.cand-row { display: grid; grid-template-columns: 9rem 1fr 3.4rem; align-items: center; gap: .5rem; margin: .18rem 0; }
