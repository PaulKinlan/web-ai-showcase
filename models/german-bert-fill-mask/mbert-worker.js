// Multilingual mBERT fill-mask worker — the "generalist" side of the German-native vs multilingual
// contrast. Model: Xenova/bert-base-multilingual-cased (task: fill-mask), WASM, q8. Loaded ON DEMAND.
//
// mBERT spread a 119,547-token WordPiece vocabulary across ~104 languages; the German DistilBERT spent
// its whole 31,102-token budget on German. Running the SAME German [MASK] sentence through both shows
// what a language specialist buys you. Same "[MASK]" WordPiece masking style → an apples-to-apples
// comparison (unlike XLM-R, which would need "<mask>").
//
// We load the tokenizer + model manually (AutoModelForMaskedLM) to read the exact masked-token logits.

import { TRANSFORMERS_URL } from "/web-ai-showcase/lib/webai.js";

const MODEL_ID = "Xenova/bert-base-multilingual-cased";
let tokenizer = null;
let model = null;
const device = "wasm";
