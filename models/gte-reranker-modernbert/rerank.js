// Front-end helpers for the GTE-reranker-ModernBERT cross-encoder pages. Owns the worker handshake and
// the renderers (ranked passage list, before/after reordering, cross-encoder-vs-lexical contrast).
// All inference lives in worker.js (off the main thread, Transformers.js ModernBERT cross-encoder).
const WORKER_URL = "/web-ai-showcase/models/gte-reranker-modernbert/worker.js";
