// Front-end helpers for the wav2vec2-XLSR-53 (Mandarin Chinese) pages. Keeps each page thin: worker
...
// this model is XLSR-53 fine-tuned for MANDARIN CHINESE — a CHARACTER-level recogniser over a ~3,500-symbol
// hanzi vocab — so it is language-specialised for Chinese. The engine is the same CTC shape (per-frame
// argmax → collapse), which lets the page visualise the collapse over Chinese characters.

const WORKER_URL = "/web-ai-showcase/models/chinese-xlsr-asr/worker.js";
const TARGET_RATE = 16000;

export class ChineseXlsrEngine {
  constructor() {
...
/** Render per-character forced-alignment chips (Chinese character + start–end seconds). */
