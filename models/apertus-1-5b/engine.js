// Front-end helpers for the Apertus-v1.1-1.5B pages: the worker handshake, streaming plumbing, and
// the shared widget CSS. Inference lives in worker.js (WebAssembly / CPU, INT4-QAD dtype q4, pinned
// to transformers.js 4.2.0). Every page imports this so the chat loop + "see inside" stay identical.

const WORKER_URL = "/web-ai-showcase/models/apertus-1-5b/worker.js";

export class ApertusEngine {
  constructor() {
  ...
  /** Load the model (WASM / CPU, dtype q8). Resolves with the device string. */
  load(onProgress) {
