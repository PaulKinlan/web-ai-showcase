// TrOCR HANDWRITING OCR worker — all inference off the main thread so the control UI stays
...
//
// Model: Xenova/trocr-small-handwritten (task: image-to-text), WASM backend, q8. ~64 MB.
