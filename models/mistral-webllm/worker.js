// Mistral 7B Instruct v0.3 (WebLLM) worker — chat generation off the main thread via MLC's WebGPU
...
// Model: Mistral-7B-Instruct-v0.3-q4f16_1-MLC (Mistral AI, 7.2B params, instruction-tuned).
// This is the catalogue's most capable model — a ~4 GB download, so the page labels the cost honestly.
