// Front-end helpers for the BERT fill-mask pages. Thin: owns the worker handshake + renderers.
// All inference (masked-LM logits, softmax, candidate scoring) lives in worker.js, off the main thread.

const WORKER_URL = "/web-ai-showcase/models/bert-fill-mask/worker.js";
...
.cand-row { display: grid; grid-template-columns: 7rem 1fr 3.4rem; align-items: center; gap: .5rem; margin: .18rem 0; }
