// Shared front-end helpers for the DeBERTa zero-shot classification pages. Keeps each page thin: it owns
// the worker handshake and the renderers (ranked label scores, the 3-way NLI entailment breakdown).
// All inference lives in worker.js (off the main thread).

const WORKER_URL = "/web-ai-showcase/models/zero-shot-text/worker.js";
...
.label-pills { display: flex; flex-wrap: wrap; gap: .3rem; margin-top: .3rem; }
`;
