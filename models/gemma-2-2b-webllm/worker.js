// Gemma 2 2B (WebLLM) worker — chat generation off the main thread via MLC's WebGPU engine.
...
// Model: gemma-2-2b-it-q4f16_1-MLC (Google Gemma 2, 2.6B params, instruction-tuned).
