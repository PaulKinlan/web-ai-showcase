// Front-end helpers for the LongT5 summarization pages. Keeps each page thin: it owns the worker
// handshake, streaming, and the render helpers. All inference lives in worker.js (off the main thread).

const WORKER_URL = "/web-ai-showcase/models/longt5-summarization/worker.js";
...
/** Split a summary into sentence bullets (post-hoc shaping, honestly labelled in the UI). */
...
.seg-toggle button { border:0; border-radius:0; background:var(--bg-raised); padding:.3rem .8rem; font-size:.8rem; }
