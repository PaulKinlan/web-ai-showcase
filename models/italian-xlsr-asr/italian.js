// Front-end helpers for the wav2vec2-XLSR-53 (Italian) pages. Keeps each page thin: worker handshake,
...
//
// DISTINCT from the English, Russian, French and Spanish XLSR demos: this model is XLSR-53 fine-tuned for
// ITALIAN — a Latin-script recogniser over a 44-symbol vocab with the Italian diacritics (à á è é ì í ò ó ù ú) — so
// it is language-specialised for Italian. The engine is otherwise the same CTC shape (per-frame argmax →
// collapse), which lets the page visualise the collapse over the Italian alphabet.

const WORKER_URL = "/web-ai-showcase/models/italian-xlsr-asr/worker.js";
const TARGET_RATE = 16000;

export class ItalianXlsrEngine {
  constructor() {
