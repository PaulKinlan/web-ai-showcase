// Route-complete real-browser acceptance for Xenova/all-mpnet-base-v2 (sentence-transformers/all-mpnet-base-v2).
// Drives every overview/Basics/Practical/Wild/Multi-model route at desktop + mobile.
// Every advertised stage runs for real: Xenova/all-mpnet-base-v2 and Xenova/ms-marco-MiniLM-L-6-v2.
import {
  CDP,
  closePage,
  DESKTOP,
