// Route-complete acceptance validator for the distinct MobileNetV4-Conv-Small e2400 ImageNet family.
...
// Multi-model is forced down its uncertain path so BOTH MobileNetV4 and ViT execute for real.
...
const SLUG = "mobilenetv4-conv-small-e2400-r224-in1k";
const MODEL_ID = "onnx-community/mobilenetv4_conv_small.e2400_r224_in1k";
const ROUTES = {
  overview: "models/mobilenetv4-conv-small-e2400-r224-in1k/",
  basics: "models/mobilenetv4-conv-small-e2400-r224-in1k/basics/",
  practical: "models/mobilenetv4-conv-small-e2400-r224-in1k/practical/",
  wild: "models/mobilenetv4-conv-small-e2400-r224-in1k/wild/",
  multimodel: "models/mobilenetv4-conv-small-e2400-r224-in1k/multimodel/",
};
...
async function runRoute(routeName, viewportName, viewport, first = false) {
  ...
  try {
    ...
    if (routeName === "overview") {
      ...
      check(
        `${viewportName} multimodel runs MobileNetV4 AND ViT stages`,
    ...
    await screenshot(cdp, page.sessionId, `/tmp/mobilenetv4-${routeName}-${viewportName}.png`);
    pass = true;
  } finally {
